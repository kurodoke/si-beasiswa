...
interface PageProps {
    penerimaBeasiswa: Penerima[];
}

export default function Index({ penerimaBeasiswa }: PageProps) {
    return (
        <PublicLayout>
            <Head title='Selamat Datang di SI Beasiswa UNIB' />
                ...
                <div className='container px-4 md:px-6 text-center'>
                    <div className='space-y-4'>
                        ...
                        <p className='mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400'>
                            Platform terpusat untuk pendataan dan verifikasi penerima beasiswa di lingkungan Universitas Bengkulu.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    {penerimaBeasiswa.length > 0 ? (
                        <div className='mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-12'>
                         ...
                         <div className="text-center mt-12 text-gray-500">
                            Belum ada data penerima beasiswa yang bisa ditampilkan.
                        </div>
                    )}
                </div>
            </section>
