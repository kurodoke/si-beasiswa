                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Selamat datang di dasbor beasiswa Anda.
                        </p>
                    </div>
                    <Link href={lapor.create().url}>
                        <Button>+ Lapor Beasiswa</Button>
                    </Link>
                </div>

                <Card>
                    <CardHeader>
                        <CardTitle>Riwayat Laporan Beasiswa Anda</CardTitle>
                        <CardDescription>
                        ...
                        <div className="space-y-2">
                            {laporanBeasiswa.length > 0 ? (
                                ...
                                <p className="text-center text-muted-foreground">
                                    Anda belum pernah melaporkan beasiswa.
                                </p>
                            )}
                        </div>
                    </CardContent>
