        ...
        <AppLayout>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Berikut adalah daftar laporan penerima beasiswa yang perlu divalidasi.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
                        ...
                        <TableBody>
                            ...
                            {laporans.map((laporan) => (
                                <TableRow key={laporan.id}>
                                    ...
                                    <TableCell>{laporan.beasiswa.nama_beasiswa}</TableCell>
