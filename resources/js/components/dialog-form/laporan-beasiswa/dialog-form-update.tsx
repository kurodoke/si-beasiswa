    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogContent className="md:max-h-[500px] md:max-w-[700px] lg:max-w-[800px]">
                <Form
                    {...LaporanBeasiswaController.update.form(data.id)}
                ...
                >
                    {({ processing, errors }) => (
                        <>
                            <DialogHeader>
                                <DialogTitle>Detail Laporan Beasiswa</DialogTitle>
                                <DialogDescription>
                                    Menampilkan informasi lengkap laporan beasiswa milik <b>{data.nama_mahasiswa}</b>
                                </DialogDescription>
                            </DialogHeader>
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="grid grid-cols-4 gap-4 md:grid-cols-12">
                                        ...
                                        <InputLabel
                                            ...
                                            id="jenis_beasiswa"
                                            data={data.beasiswa?.jenis_beasiswa ?? '-'}
                                        />
                                        <InputLabel
                                            className="col-span-2 md:col-span-6"
                                            title="Tanggal Mulai Beasiswa"
                                            id="penerimaan_beasiswa"
                                            data={formatDate(data.penerimaan_beasiswa)}
                                        />
                                        <InputLabel
                                            className="col-span-2 md:col-span-6"
                                            title="Tanggal Selesai Beasiswa"
                                            id="selesai_beasiswa"
                                            data={formatDate(data.selesai_beasiswa)}
                                        />
                                    </div>
                            ...
                            <DialogFooter>
                                ...
                                {userRole === 'validator' && data.status_validasi !== 'disetujui' && (
                                    <Button type="submit" disabled={processing}>
                                        ...
                                        {processing ? 'Menyimpan...' : 'Verifikasi Beasiswa'}
                                    </Button>
                                )}
                            </DialogFooter>
                        </>
