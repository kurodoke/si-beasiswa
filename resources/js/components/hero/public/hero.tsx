...
const Hero = ({
    ...
    heading = 'Sistem Informasi Laporan Beasiswa',
    description = 'Sistem yang mengelola laporan beasiswa dari mahasiswa di Program Studi Informatika Universitas Bengkulu',
    buttons = {
        primary: {
            text: 'Anda Pengelola?',
            url: '/login',
